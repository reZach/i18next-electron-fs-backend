...
import { UUID, mergeNested, groupByArray } from "./utils";
...
Backend.BackendInstance = BackendInstance;
Backend.Backend = Backend; /* Allows for { Backend } */
Backend.default = Backend; /* Allows for strict ES Module support */
module.exports = Backend; /* Sets the default export */
